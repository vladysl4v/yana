                ...
                <div className='border-b-[1px] border-gray-300'>
                    <div className="container mx-auto flex justify-between items-center mb-4">
                        ...
                        <div>
                            ...
                            <button className="bg-transparent py-2 px-4 border-2 border-yellow-500 hover:bg-yellow-500 transition-all duration-200 hover:text-white hover:font-thin rounded-xl font-bold mr-2">Register</button>
                        </div>
                    </div>
                </div>
            </header>
